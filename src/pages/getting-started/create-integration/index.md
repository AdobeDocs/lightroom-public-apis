...
4. Verify access to the Lightroom Services through a [Services Health Check](../service-health-check/index.md) and by [Authenticating Customers](../authenticate-customers/index.md).
